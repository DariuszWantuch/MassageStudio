    ...
    public class ServiceController : Controller
    {
        ...
        public IActionResult Upsert(int? id)
        {
            ServVM = new ServiceVM()
            {
                ...
                TimeServiceList = _unitOfWork.TimeService.GetTimeServiceListForDropDown(),
            };
            if (id != null)
            {
        ...
        public IActionResult Upsert()
        {
            ...
            else
            {
                ...
                ServVM.TimeServiceList = _unitOfWork.TimeService.GetTimeServiceListForDropDown();
                return View(ServVM);
            }
        }
        ...
        {
            return Json(new { data = _unitOfWork.Service.GetAll(includeProperties: "Category,TimeService") });
        }
