    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult Index()
        {
            HomeVM = new HomeViewModel()
            {
                ...
                ServiceList = _unitOfWork.Service.GetAll(includeProperties: "TimeService")
            };
        ...
        {
            var serviceFromDb = _unitOfWork.Service.GetFirstOrDefault(includeProperties: "Category,TimeService", filter: c => c.Id == id);
